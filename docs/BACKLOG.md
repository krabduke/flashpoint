...
- 2026-09-05 · torch · a1c9f1e · the player's light bubble was gated on flHits.length, a stale ray count, so dousing the torch changed the picture by ±1 while detection correctly went to zero. It now follows beamOn and collapses to 30px/0.34 — dark, but still findable
